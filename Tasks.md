...
## Tầng 2 — Tính năng Trung cấp (chưa bắt đầu)

- [ ] Biểu đồ tăng trưởng trực quan theo thời gian (đường cong percentile/Z-score qua nhiều lần khám)
- [ ] Chuẩn kép WHO (≤5 tuổi) / WHO 2007 hoặc CDC (>5 tuổi) thay vì 1 công thức xấp xỉ chung cho mọi độ tuổi
- [ ] Cơ sở dữ liệu thành phần dinh dưỡng thực phẩm Việt Nam (thay logic ước lượng heuristic hiện tại trong menu.service.ts)
- [ ] Lọc thực đơn theo dị ứng thực phẩm / tôn giáo / ăn chay
...
- [ ] Quản lý người dùng & phân quyền (bác sĩ / điều dưỡng / admin)
- [ ] Nhắc lịch tái khám qua SMS/Zalo/email
- [ ] Tìm kiếm, lọc, thống kê danh sách bệnh nhân (hiện tab Nhật Ký mới có bảng đơn giản)
